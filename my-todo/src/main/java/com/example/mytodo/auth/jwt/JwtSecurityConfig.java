...
// import com.example.mytodo.user.service.CustomUserDetailsService;
...
// .requestMatchers("/authenticate", "/signup", "/error").permitAll() // 해당 경로는
// 인증 없이 접근 가능
// .requestMatchers(HttpMethod.OPTIONS, "/**", "/").permitAll() // CORS 사전 요청
// Preflight request)접근 허용
// .anyRequest()
// .authenticated()) // 그 외 모든 요청은 인증 필요
// .csrf(AbstractHttpConfigurer::disable) // CSRF 보호 기능 비활성화
// .sessionManagement(session ->
// session.sessionCreationPolicy(SessionCreationPolicy.STATELESS)) // 세션 사용x
...
// @Bean
// public AuthenticationManager authenticationManager(CustomUserDetailsService
